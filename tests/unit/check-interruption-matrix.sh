...
SUITE_DIR="$UNIT_DIR"
MODULES="$ROOT/bin/cockpit_control.py $ROOT/bin/cockpit_control_locks.py $ROOT/bin/cockpit_control_journal.py $ROOT/bin/cockpit_control_projection.py $ROOT/bin/cockpit_control_lifecycle.py"
