...
- **Skill set is explicit and managed**: global install manages exactly the enumerated roles in `cmd-global.sh` plus `cockpit-wake`, `cockpit-overseer`, and `cockpit-trace`.
