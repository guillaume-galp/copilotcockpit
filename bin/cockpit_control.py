...
control-lock protocol, and one immutable event-publication protocol.
"""
...
def read_committed_events(root: Path, control_id: str) -> EventHistory:
    ...
    return EventHistory(root=root, events=tuple(committed), pending=_read_pending_debris(root))
